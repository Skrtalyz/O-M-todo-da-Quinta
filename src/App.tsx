...
import { ElitePreservesSection } from './components/ElitePreservesSection';
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#FAF7F2] text-slate-900 selection:bg-amber-500/20 selection:text-slate-900 font-sans">
      <main className="flex-grow">
        {/* SECÇÃO 01: HEADLINE E APRESENTAÇÃO DO MÉTODO */}
        <HeroSection
        ...
        {/* SECÇÃO 03: BÓNUS EXCLUSIVOS (O Empilhamento de Valor) */}
        <BonusesSection
          onOpenCheckout={handleOpenCheckout}
          onScrollToOffer={handleScrollToOffer}
        />

        {/* SECÇÃO 04: AS CONSERVAS DE ELITE QUE VAIS DOMINAR */}
        <ElitePreservesSection
          onScrollToOffer={handleScrollToOffer}
        />
